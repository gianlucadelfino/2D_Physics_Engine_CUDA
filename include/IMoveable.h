...
/**
* IMoveable. Anything on screen that can move should use an IMoveable, i.e. have
* a composite object that inherits from IMoveable.
*/
class IMoveable
{
public:
    ...
    */
    std::unique_ptr<IMoveable> Clone() const; // non virtual to check that it
    ...
    */
    ...
    /**
    * SetConstraint adds the pointer to the position the current instance is
    ...
    */
    ...
    /**
    * IsHit receives a set of coordinates and returns true if hit (default to
    * false)
...
protected:
    ...
    std::shared_ptr<C2DVector> _constraint;
