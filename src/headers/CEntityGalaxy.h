...
/**
* CEntityGalaxy is the Entity that manages the galaxy simulation. Given a Star
* Entity as a prototype, the constructor will populate the galaxy
* with star_number_ elements.
* CEntityGalaxy follows the "Composite" patter: it IS an IEnity and manages many
* IEnities underneath it.
*/
class CEntityGalaxy : public CEntity
{
public:
    CEntityGalaxy(unsigned int id_,
