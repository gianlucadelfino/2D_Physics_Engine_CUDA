...
scene_cloth::scene_cloth(world_manager& world_)
    : scene_base(world_, {255, 255, 255, 0}),
      _font(std::make_unique<font_handler>("assets/pcseniorSmall.ttf", 20))
{
  ...
  std::unique_ptr<drawable_link> cloth_drawable = std::make_unique<drawable_link>();
...
void scene_cloth::init()
{
  ...
  std::unique_ptr<drawable_button> main_menu_button_drawable = std::make_unique<drawable_button>(
      _font, "MAIN MENU", vec2(200.0f, 22.0f), black_color, button_label_color);
  ...
  std::unique_ptr<drawable_button> instructionsfirst_label_drawable =
      std::make_unique<drawable_button>(
          _font, "click and hold to", vec2(220.0f, 22.0f), white_color, label_color);
  ...
  std::unique_ptr<drawable_button> instructionssecond_label_drawable =
      std::make_unique<drawable_button>(
          _font, "drag the cloth", vec2(220.0f, 22.0f), white_color, label_color);
