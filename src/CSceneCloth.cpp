...
void CSceneCloth::Init()
{
	...
	std::unique_ptr< CDrawableButton > main_menu_button_drawable( new CDrawableButton( this->mp_font, this->mp_screen, "MAIN MENU", C2DVector( 200.0f, 22.0f ), black_color, button_label_color ) );
